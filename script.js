...
function showSingleProject(projects) {
    $('.title').on('click', function() {
        ...
        if (!filtered[0].img2) {
            $('#singleProject').append('<p class="back hov">CLOSE <i class="fa fa-times-circle" aria-hidden="true"></i></p><div class="single"><div class="singleLeftCol"><h3 class="title">'+clickedTitle+'</h3><p class="pub">'+clickedPub+'</p><p class="desc">'+clickedDesc+'</p><p class="tech">'+clickedTech+'</p><br/><a class="hov" href="'+viewProject+'"><p class="hov viewProject">View Project→</p></a></div><div class="singleRightCol"><img class="singleProjectImg" alt="'+alt+'"src="'+clickedImg+'"/></div></div> ');
            ...
            $('#singleProject').append('<p class="back hov">CLOSE <i class="fa fa-times-circle" aria-hidden="true"></i></p><div class="single"><div class="singleLeftCol"><h3 class="title">'+clickedTitle+'</h3><p class="pub">'+clickedPub+'</p><p class="desc">'+clickedDesc+'</p><p class="tech">'+clickedTech+'</p><br/><a class="hov" href="'+viewProject+'"><p class="hov viewProject">View Project→</p></a></div><div class="singleRightCol"><img class="singleProjectImg" alt="'+alt+'"src="'+clickedImg+'"/><img class="singleProjectImg" alt="'+alt2+'"src="'+clickedImg2+'"/><img class="singleProjectImg" alt="'+alt3+'"src="'+clickedImg3+'"/><img class="singleProjectImg" alt="'+alt4+'"src="'+clickedImg4+'"/></div></div> ');
        }
